...
<form id="form" onsubmit="submitted()" method="post">
    ...
    <input type="number" name="userId" id="userId" onkeyup="showUsername(this.value); update()" autocomplete=off
           required> <span id="txtHint"></span><br>
    <label>e-mail: </label>
    <input type="email" name="email" id="email" onkeyup="showEmailValidity(); update()" required><span
            id="emailHint"></span><br>
    <label>confirm email: </label>
    <input type="email" name="cEmail" id="confEmail" onkeyup="showCheckEmail(); update()" required> <span
            id="checkEmail"></span><br>
    <label>password: </label>
    <input type="password" name="password" id="pass" onkeyup="update()" required><br>
    <label>confirm password: </label>
    <input type="password" name="cPassword" id="confPass" onkeyup="showCheckPass(); update()" required> <span
            id="checkPass"></span><br>
    <input type="checkbox" name="TU" id="checkBox" onclick="update()" required><span id="textCheckBox"> I accept the <a
                href="legal/TU.php?TU=user" target="_blank">terms of uses</a></span><br>
